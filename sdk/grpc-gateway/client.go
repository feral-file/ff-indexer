...
func (i *GRPCClient) GetTokenByIndexID(ctx context.Context, indexID string) (*indexer.Token, error) {
...
func (i *GRPCClient) PushProvenance(ctx context.Context, indexID string, lockedTime time.Time, provenance indexer.Provenance) error {
...
func (i *GRPCClient) UpdateOwner(ctx context.Context, indexID, owner string, updatedAt time.Time) error {
...
func (i *GRPCClient) UpdateOwnerForFungibleToken(ctx context.Context, indexID string, lockedTime time.Time, to string, total int64) error {
...
func (i *GRPCClient) IndexAccountTokens(ctx context.Context, owner string, accountTokens []indexer.AccountToken) error {
...
func (i *GRPCClient) GetDetailedToken(ctx context.Context, indexID string, burnedIncluded bool) (indexer.DetailedToken, error) {
...
func (i *GRPCClient) GetTotalBalanceOfOwnerAccounts(ctx context.Context, addresses []string) (int64, error) {
...
func (i *GRPCClient) GetOwnerAccountsByIndexIDs(ctx context.Context, indexIDs []string) ([]string, error) {
...
func (i *GRPCClient) GetOwnersByBlockchainContracts(ctx context.Context, blockchainContracts map[string][]string) ([]string, error) {
...
func (i *GRPCClient) CheckAddressOwnTokenByCriteria(ctx context.Context, address string, criteria indexer.Criteria) (bool, error) {
...
func (i *GRPCClient) GetETHBlockTime(ctx context.Context, blockHash string) (time.Time, error) {
...
func (i *GRPCClient) GetIdentity(ctx context.Context, address string) (indexer.AccountIdentity, error) {
...
func (i *GRPCClient) SendTimeSeriesData(
	ctx context.Context,
...
func (i *GRPCClient) GetTimeSeriesData(
	ctx context.Context,
...
func (i *GRPCClient) GetSaleRevenues(
	ctx context.Context,
	filter indexer.SalesFilterParameter,
...
func (i *GRPCClient) GetExchangeRate(
	ctx context.Context,
...
func (i *GRPCClient) UpdateAssetsConfiguration(ctx context.Context, IDs []string, configuration *indexer.AssetConfiguration) error {
...
func (i *GRPCClient) CheckAssetCreator(ctx context.Context, IDs []string, creatorAddresses []string) (bool, error) {

...
func (e *IndexEngine) IndexETHTokenByOwner(_ context.Context, owner string, offset int) ([]AssetUpdates, error) {
...
func (e *IndexEngine) IndexETHToken(_ context.Context, owner, contract, tokenID string) (*AssetUpdates, error) {
...
func (e *IndexEngine) IndexETHTokenLastActivityTime(_ context.Context, contract, tokenID string) (time.Time, error) {
	return e.opensea.GetTokenLastActivityTime(contract, tokenID)
}

// IndexETHTokenOwners indexes owners of a given token
func (e *IndexEngine) IndexETHTokenOwners(_ context.Context, contract, tokenID string) (map[string]int64, error) {

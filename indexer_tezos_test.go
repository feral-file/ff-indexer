...
func TestIndexTezosTokenProvenance(t *testing.T) {
	engine := New("", []string{}, map[string]string{}, nil, tzkt.New(""), nil, nil, nil)
...
func TestIndexTezosToken(t *testing.T) {
	...
	engine := New("", []string{}, map[string]string{}, nil, tzkt.New(""), fxhash.New("https://api.fxhash.xyz/graphql"), objkt.New("https://data.objkt.com/v3/graphql"), nil)
...
func TestIndexTezosTokenByOwner(t *testing.T) {
	...
	engine := New("", []string{}, map[string]string{}, nil, tzkt.New(""), nil, objkt.New("https://data.objkt.com/v3/graphql"), nil)

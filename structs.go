...
type Artist struct {
	ID   string `json:"id" bson:"id"`     // Artist blockchain address
	Name string `json:"name" bson:"name"` // <creator.user.username>,
	URL  string `json:"url" bson:"url"`   // <OpenseaAPI/creator.address>,
}

...
func (s *Server) startIndexWorkflow(c context.Context, owner, blockchain string, workflowFunc interface{}) {
	...
	if err != nil {
		log.ErrorWithContext(c, errors.New("fail to start indexing workflow"), zap.Error(err), zap.String("owner", owner), zap.String("blockchain", blockchain))
	} else {
		log.InfoWithContext(c, "start workflow for indexing tokens", zap.String("owner", owner), zap.String("blockchain", blockchain), zap.String("workflow_id", workflow.ID))
	}
}

// SwapNFT migrate existent nft from a blockchain to another
func (s *Server) SwapNFT(c *gin.Context) {
...
func (s *Server) RefreshProvenance(c *gin.Context) {
...
func (s *Server) IndexNFTs(c *gin.Context) {
...
func (s *Server) IndexNFTsV2(c *gin.Context) {
...
func (s *Server) IndexOneNFT(c *gin.Context) {
...
func (s *Server) IndexHistory(c *gin.Context) {

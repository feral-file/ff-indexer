...
func (s *Server) QueryNFTs(c *gin.Context) {
...
func (s *Server) IndexMissingTokens(c *gin.Context, idMap map[string]bool) {
...
func (s *Server) OwnedNFTIDs(c *gin.Context) {
...
func (s *Server) SearchNFTs(c *gin.Context) {
...
func (s *Server) fetchIdentity(c context.Context, accountNumber string) (*indexer.AccountIdentity, error) {
...
func (s *Server) refreshIdentity(accountNumber string) {
...
func (s *Server) ForceReindexNFT(c *gin.Context) {
...
func (s *Server) CreateDemoTokens(c *gin.Context) {
...
func (s *Server) GetAccountNFTsV2(c *gin.Context) {
...
func (s *Server) CountAccountNFTsV2(c *gin.Context) {
...
func (s *Server) QueryNFTsV2(c *gin.Context) {
...
func (s *Server) GetETHBlockTime(c *gin.Context) {
...
func (s *Server) GetCollectionsByCreators(c *gin.Context) {
...
func (s *Server) GetCollectionByID(c *gin.Context) {
...
func (s *Server) GetExchangeRate(c *gin.Context) {

...
type IndexerClient interface {
	...
	SendTimeSeriesData(ctx context.Context, in *TimeSeriesRecord, opts ...grpc.CallOption) (*Empty, error)
}
...
func (c *indexerClient) SendTimeSeriesData(ctx context.Context, in *TimeSeriesRecord, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
...
type IndexerServer interface {
	...
	SendTimeSeriesData(context.Context, *TimeSeriesRecord) (*Empty, error)
...
func (UnimplementedIndexerServer) SendTimeSeriesData(context.Context, *TimeSeriesRecord) (*Empty, error) {
...
func _Indexer_SendTimeSeriesData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IndexerServer).SendTimeSeriesData(ctx, req.(*TimeSeriesRecord))
	}
	return interceptor(ctx, in, info, handler)
}

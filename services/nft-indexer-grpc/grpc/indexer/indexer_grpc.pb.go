...
func (c *indexerClient) GetDetailedToken(ctx context.Context, in *GetDetailedTokenRequest, opts ...grpc.CallOption) (*DetailedToken, error) {
...
func (UnimplementedIndexerServer) GetDetailedToken(context.Context, *GetDetailedTokenRequest) (*DetailedToken, error) {
...
func _Indexer_GetDetailedToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IndexerServer).GetDetailedToken(ctx, req.(*GetDetailedTokenRequest))
	}
	return interceptor(ctx, in, info, handler)
}

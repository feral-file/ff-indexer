...
var file_indexer_proto_rawDesc = []byte{
	...
	0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x32, 0xfd, 0x04, 0x0a, 0x07, 0x49, 0x6e, 0x64, 0x65,
	...
	0x64, 0x72, 0x65, 0x73, 0x73, 0x65, 0x73, 0x42, 0x10, 0x5a, 0x0e, 0x2e, 0x2f, 0x67, 0x72, 0x70,
...
var file_indexer_proto_msgTypes = make([]protoimpl.MessageInfo, 24)
var file_indexer_proto_goTypes = []interface{}{
	...
	nil,                                        // 22: GetOwnersByBlockchainContractsRequest.BlockchainContractsEntry
	nil,                                        // 23: Token.OwnersEntry
}
var file_indexer_proto_depIdxs = []int32{
	2,  // 0: CheckAddressOwnTokenByCriteriaRequest.Criteria:type_name -> Criteria
	22, // 1: GetOwnersByBlockchainContractsRequest.BlockchainContracts:type_name -> GetOwnersByBlockchainContractsRequest.BlockchainContractsEntry
	...
	23, // 11: Token.Owners:type_name -> Token.OwnersEntry
	...
	19, // 25: Indexer.GetTokenByIndexID:output_type -> Token
	16, // 26: Indexer.PushProvenance:output_type -> Empty
	16, // 27: Indexer.UpdateOwner:output_type -> Empty
	16, // 28: Indexer.UpdateOwnerForFungibleToken:output_type -> Empty
	16, // 29: Indexer.IndexAccountTokens:output_type -> Empty
	7,  // 30: Indexer.GetDetailedToken:output_type -> DetailedToken
	6,  // 31: Indexer.GetTotalBalanceOfOwnerAccounts:output_type -> TotalBalance
	4,  // 32: Indexer.GetOwnerAccountsByIndexIDs:output_type -> Addresses
	0,  // 33: Indexer.CheckAddressOwnTokenByCriteria:output_type -> CheckAddressOwnTokenByCriteriaResponse
	4,  // 34: Indexer.GetOwnersByBlockchainContracts:output_type -> Addresses

...
var file_indexer_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x61, 0x52, 0x06, 0x4c, 0x61, 0x74, 0x65, 0x73, 0x74, 0x22, 0x91, 0x06, 0x0a, 0x0f,
	...
	0x18, 0x0b, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x42, 0x61, 0x73, 0x65, 0x50, 0x72, 0x69, 0x63,
	...
	0x4f, 0x72, 0x69, 0x67, 0x69, 0x6e, 0x61, 0x6c, 0x46, 0x69, 0x6c, 0x65, 0x55, 0x52, 0x4c, 0x22,
	...
	0x74, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x32, 0xc3, 0x02, 0x0a, 0x07, 0x49, 0x6e, 0x64,
	...
	0x2e, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x65, 0x64, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x42, 0x10,
...
var file_indexer_proto_depIdxs = []int32{
	...
	5,  // 6: IndexAccountTokensRequest.AccountTokens:type_name -> AccountToken
	12, // 7: PushProvenanceRequest.Provenance:type_name -> Provenance
	14, // 8: Token.Owners:type_name -> Token.OwnersEntry
	13, // 9: Token.OriginTokenInfo:type_name -> BaseTokenInfo
	12, // 10: Token.Provenances:type_name -> Provenance
	10, // 11: Indexer.GetTokensByIndexID:input_type -> IndexID
	9,  // 12: Indexer.PushProvenance:input_type -> PushProvenanceRequest
	7,  // 13: Indexer.UpdateOwner:input_type -> UpdateOwnerRequest
	6,  // 14: Indexer.UpdateOwnerForFungibleToken:input_type -> UpdateOwnerForFungibleTokenRequest
	4,  // 15: Indexer.IndexAccountTokens:input_type -> IndexAccountTokensRequest
	10, // 16: Indexer.GetDetailedToken:input_type -> IndexID
	11, // 17: Indexer.GetTokensByIndexID:output_type -> Token
	8,  // 18: Indexer.PushProvenance:output_type -> Empty
	8,  // 19: Indexer.UpdateOwner:output_type -> Empty
	8,  // 20: Indexer.UpdateOwnerForFungibleToken:output_type -> Empty
	8,  // 21: Indexer.IndexAccountTokens:output_type -> Empty
	0,  // 22: Indexer.GetDetailedToken:output_type -> DetailedToken
